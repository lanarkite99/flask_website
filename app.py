...
app.config["SECRET_KEY"]="myapp756"
app.config["SQLALCHEMY_DATABASE_URI"]="sqlite:///data.db"
app.config["MAIL_SERVER"]="smtp.gmail.com"
app.config["MAIL_PORT"]=465
app.config["MAIL_USE_SSL"]=True
app.config["MAIL_USERNAME"]="meetapple191@gmail.com"
app.config["MAIL_PASSWORD"]=os.getenv("py_web")
db=SQLAlchemy(app)
...
def index():
    if request.method=="POST":
        ...
        message_body=(f"{first_name}, thank you for your submission,\n"
                      f"you have submitted the application on {date}\n"
                      f"Thank you")
